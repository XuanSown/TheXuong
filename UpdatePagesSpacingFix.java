...
public class UpdatePagesSpacingFix {
    public static void main(String[] args) throws Exception {
        ...
        for (File f : dir.listFiles()) {
            if (f.getName().endsWith(".html")) {
                ...
                content = content.replace("<div style=\"height: 100px;\"></div>\n<div class=\"container mb-5 flex-grow-1 d-flex flex-column justify-content-center\">",
                        "<div class=\"container mb-5 flex-grow-1\" style=\"margin-top: 140px;\">");
                Files.write(f.toPath(), content.getBytes("UTF-8"));
            }
        }
        System.out.println("FIXED SPACING PROPERLY");
    }
}
