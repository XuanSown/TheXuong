...
GO
-- 1. Chuyển sang database hệ thống (đứng bên ngoài mới xóa được)
USE master;
GO

-- 2. Đưa database về chế độ 1 người dùng & Ngắt ngay lập tức các kết nối khác
ALTER DATABASE dbTheXuong SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
GO

-- 3. Tiến hành xóa
DROP DATABASE dbTheXuong;
GO
...
-- Cách 1: Nếu bạn đang làm dự án mới, chưa có dữ liệu quan trọng ở bảng con
-- Hãy xóa các bảng con trước (thường là các bảng này đang giữ chân bảng Products)
    DROP TABLE IF EXISTS OrderDetails;  -- Xóa bảng chi tiết đơn hàng
    DROP TABLE IF EXISTS CartItems;     -- Xóa bảng giỏ hàng
    DROP TABLE IF EXISTS Carts;         -- Xóa bảng giỏ hàng (nếu có)
    DROP TABLE IF EXISTS Reviews;       -- Xóa bảng đánh giá (nếu có)

-- Sau đó mới xóa được bảng Products
    DROP TABLE Products;
CREATE TABLE Users
(
...
VALUES (N'McLAREN RACING Speedcat', 'Puma', N'Khác', N'Giày', 2800000,
       ...
       (N'Áo Thun Đồ Họa McLAREN RACING Nam', 'Puma', N'Đua xe', N'Áo', 1300000,
        N'https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_2000,h_2000/global/637516/01/fnd/VNM/fmt/png/%C3%81o-Thun-%C4%90%E1%BB%93-H%E1%BB%8Da-McLAREN-RACING-Nam',
       ...
       (N'Quần McLAREN RACING Nam', 'Puma', 'Đua xe', N'Quần', 2200000,
        N'https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_2000,h_2000/global/637521/01/mod01/fnd/VNM/fmt/png/Qu%E1%BA%A7n-McLAREN-RACING-Nam',
       ...
       (N'Áo Khoác Thể Thao BMW M MOTORSPORT Sportswear MT7 Nam', 'Puma', 'Đua xe', N'Áo', 3100000,
        N'https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_2000,h_2000/global/634875/01/fnd/VNM/fmt/png/%C3%81o-Kho%C3%A1c-Th%E1%BB%83-Thao-BMW-M-MOTORSPORT-Sportswear-MT7-Nam',
       ...
       (N'Áo khoác nỉ nam BMW M Motorsport MT7+', 'Puma', N'Đua xe', N'Áo', 3100000,
        N'https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_2000,h_2000/global/627453/01/fnd/VNM/fmt/png/%C3%81o-kho%C3%A1c-n%E1%BB%89-nam-BMW-M-Motorsport-MT7+',
       ...
       (N'Áo Hoodie McLAREN RACING Nam', 'Puma', N'Đua xe', N'Áo', 2500000,
        N'https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_2000,h_2000/global/637507/03/fnd/VNM/fmt/png/%C3%81o-Hoodie-McLAREN-RACING-Nam',
       ...
       (N'Áo thun nam PUMA x ASTON MARTIN ARAMCO F1® TEAM Essentials', 'Puma', N'Khác', N'Áo', 800000,
        N'https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_2000,h_2000/global/635393/04/fnd/VNM/fmt/png/%C3%81o-thun-nam-PUMA-x-ASTON-MARTIN-ARAMCO-F1%C2%AE-TEAM-Essentials',
       ...
       (N'Áo Dệt Kim Cổ Tròn PUMA x PORSCHE LEGACY Lifestyle Nam', 'Puma', N'Khác', N'Áo', 3100000,
        N'https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_2000,h_2000/global/632675/15/fnd/VNM/fmt/png/%C3%81o-D%E1%BB%87t-Kim-C%E1%BB%95-Tr%C3%B2n-PUMA-x-PORSCHE-LEGACY-Lifestyle-Nam',
       ...
       (N'Quần short Scuderia Ferrari PM1 cho nam', 'Puma', N'Khác', N'Quần', 2100000,
        N'https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_2000,h_2000/global/634245/01/fnd/VNM/fmt/png/Qu%E1%BA%A7n-short-Scuderia-Ferrari-PM1-cho-nam',
       ...
       (N'Quần Jogger CLOUDSPUN Nữ', 'Puma', N'Khác', N'Quần', 980000,
        N'https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_2000,h_2000/global/527503/01/fnd/VNM/fmt/png/Qu%E1%BA%A7n-Jogger-CLOUDSPUN-N%E1%BB%AF',
       ...
       (N'Quần Short 2 Trong1 PUMA x HYROX Nữ', 'Puma', N'Khác', N'Quần', 1550000,
        N'https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_2000,h_2000/global/527633/45/fnd/VNM/fmt/png/Qu%E1%BA%A7n-Short-2-Trong1-PUMA-x-HYROX-N%E1%BB%AF',
       ...
       (N'Quần Cargo FUTURE.PUMA.ARCHIVE Nữ', 'Puma', N'Khác', N'Quần', 1800000,
        N'https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_2000,h_2000/global/633827/01/fnd/VNM/fmt/png/Qu%E1%BA%A7n-Cargo-FUTURE.PUMA.ARCHIVE-N%E1%BB%AF',
       ...
       (N'Áo Thun CLOUDSPUN Nam', 'Puma', N'Khác', N'Áo', 850000,
        N'https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_2000,h_2000/global/527593/01/fnd/VNM/fmt/png/%C3%81o-Thun-CLOUDSPUN-Nam',
       ...
       (N'Áo Thun Khóa Kéo 1/4 PUMA x HYROX CLOUDSPUN Nữ', 'Puma', N'Khác', N'Áo', 1750000,
        N'https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_2000,h_2000/global/527635/01/fnd/VNM/fmt/png/%C3%81o-Thun-Kh%C3%B3a-K%C3%A9o-1/4-PUMA-x-HYROX-CLOUDSPUN-N%E1%BB%AF',
       ...
       (N'Ba lô PUMA x HYROX 46L', 'Puma', N'Khác', N'Balo', 4030000,
        N'https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_2000,h_2000/global/091611/01/fnd/VNM/fmt/png/Ba-l%C3%B4-PUMA-x-HYROX-46L',
       ...
       (N'Balo trùm đầu họa tiết PUMA x RIPNDIP dành cho nam', 'Puma', N'Khác', N'Balo', 2300000,
        N'https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_2000,h_2000/global/091818/01/fnd/VNM/fmt/png/Balo-tr%C3%B9m-%C4%91%E1%BA%A7u-h%E1%BB%8Da-ti%E1%BA%BFt-PUMA-x-RIPNDIP-d%C3%A0nh-cho-nam',
       ...
       (N'Áo Đấu Sân Nhà Manchester City 2025', N'Puma', N'Bóng đá', N'Áo', 1950000,
        N'https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_2000,h_2000/global/780338/01/fnd/VNM/fmt/png/%C3%81o-Thi-%C4%90%E1%BA%A5u-S%C3%A2n-Nh%C3%A0-Manchester-City-25/26-Nam',
       ...
       (N'Giày Bóng Rổ Nike LeBron XX', N'Nike', N'Bóng rổ', N'Giày', 5200000,
        N'https://static.nike.com/a/images/t_web_pw_592_v2/f_auto/u_9ddf04c7-2a9a-4d76-add1-d15af8f0263d,c_scale,fl_relative,w_1.0,h_1.0,fl_layer_apply/81561a39-7164-4274-b067-e2ad649e2f43/LEBRON+XXIII+EP.png',
       ...
       (N'Quần Ngắn Thể Thao Adidas Tiro 23', N'Adidas', N'Bóng đá', N'Quần áo', 1100000,
        N'https://assets.adidas.com/images/h_2000,f_auto,q_auto,fl_lossy,c_fill,g_auto/7b9428da99324cb98d4eaf2b01029e1a_9366/Quan_Short_Tiro_23_League_Nhieu_mau_IC7488_01_laydown.jpg',
       ...
       (N'Áo Polo Golf Modalon Nam', N'Puma', N'Khác', N'Áo', 1100000,
        N'https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_2000,h_2000/global/635477/04/fnd/VNM/fmt/png/%C3%81o-Polo-Golf-Modalon-Nam',
        N'Quần tập luyện quốc dân với khóa kéo ở ống chân, form ôm gọn gàng, chất vải co giãn tốt.'),

       (N'Áo sơ mi nam PALAIS ARTISAN', N'Puma', N'Khác', N'Áo', 2500000,
        N'https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_2000,h_2000/global/629392/87/mod01/fnd/VNM/fmt/png/%C3%81o-s%C6%A1-mi-nam-PALAIS-ARTISAN',
       ...
       (N'Quần Short Jeans Nam PUMA x A$AP ROCKY', N'Puma', N'Khác', N'Quần', 5500000,
        N'https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_2000,h_2000/global/631066/01/mod01/fnd/VNM/fmt/png/Qu%E1%BA%A7n-Short-Jeans-Nam-PUMA-x-A$AP-ROCKY',
        N'Quần tập luyện quốc dân với khóa kéo ở ống chân, form ôm gọn gàng, chất vải co giãn tốt.'),

       (N'Váy A$AP ROCKY x PUMA dành cho nữ', N'Puma', N'Khác', N'Váy', 2300000,
        N'https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_2000,h_2000/global/633416/36/fnd/VNM/fmt/png/V%C3%A1y-A$AP-ROCKY-x-PUMA-d%C3%A0nh-cho-n%E1%BB%AF',
       ...
       (N'Áo khoác thể thao PUMA x ROSÉ T7 dành cho nữ', N'Puma', N'Khác', N'Áo', 3000000,
        N'https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_2000,h_2000/global/633793/01/fnd/VNM/fmt/png/%C3%81o-kho%C3%A1c-th%E1%BB%83-thao-PUMA-x-ROS%C3%89-T7-d%C3%A0nh-cho-n%E1%BB%AF',
       ...
       (N'Áo khoác thể thao FENTY x PUMA T7 Unisex', N'Puma', N'Khác', N'Áo', 3200000,
        N'https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_2000,h_2000/global/633626/87/fnd/VNM/fmt/png/%C3%81o-kho%C3%A1c-th%E1%BB%83-thao-FENTY-x-PUMA-T7-Unisex',
       ...
       (N'Áo thun chạy bộ Boxy coolCELL cho nam', N'Puma', N'Chạy bộ', N'Áo', 1100000,
        N'https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_2000,h_2000/global/528421/01/fnd/VNM/fmt/png/%C3%81o-thun-ch%E1%BA%A1y-b%E1%BB%99-Boxy-coolCELL-cho-nam',
