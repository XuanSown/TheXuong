      ...
      <section class="w-[1152px] mx-auto relative flex gap-8">
        ...
        <section class="flex-1">
          ...
          <div v-if="activeSport || activeBrand" class="mb-6 flex items-center gap-2">
            ...
            <button v-if="activeSport || activeBrand" @click="clearAllFilters"
          ...
          <div class="relative min-h-[400px]">
            ...
            <div v-if="isLoading" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-12 mb-8">
              <div v-for="i in 6" :key="i" class="w-full flex flex-col gap-4">
            ...
            <!-- Product List -->
            <div v-else-if="products.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-12 mb-8">
              <ProductCard v-for="product in products" :key="product.id" :product="product" />
            </div>

            <!-- No Results Message -->
            <div v-else class="absolute inset-0 flex flex-col items-center justify-center py-16">
          ...
          <!-- Pagination -->
          <div v-if="totalPages > 1 && !isLoading" class="flex justify-center items-center gap-2 mt-16">
