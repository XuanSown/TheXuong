...
public class DashboardController {
    ...
    public String showStatistics(Model model) {
        ...
        // 3. Doanh thu theo ngày (null, null = filter cả năm)
        ...
        // 1. Biểu đồ trạng thái đơn hàng (null, null = filter cả năm)
        ...
        long usersWithOrders = orderRepository.countUsersWithOrders(null, null); // Số người đã từng mua (cả năm)
